...
L["Ignore Disenchants"] = "Ignoriere Entzaubern"
L["Ignore if you open a loot window containing crystals or large shards."] = "Ignoriere Loot mit Kristallen oder großen Splittern"
...
L["Ignore Drakefire"] = "Ignoriere Drachenfeueramulett"
L["Ignore if someone raid warns about the Drakefire Amulet"] = "Ignoriere wenn jemand das Drachenfeueramulett (Onyxia Zugang) als Raidwarnung schreibt"
...
L["On Tooltip"] = "Auf Tooltip"
L["Shows Prio entries on Item Tooltips"] = "Zeige Prioritäten im Tooltip-Fenster"
...
L["TotC Dual Loot hc+nhc"] = "PdK Dual Loot hc+nhc"
L["Shows both heroic and normal version of loot on outputs, the respective other one as Playername2"] = "Zeigt sowohl heroische wie auch normale Version des Loots bei Ausgaben, das jeweils andere als Playername2. Einstellung muss vor dem Import gesetzt werden, nachträglich nicht möglich. (Tip: Nochmal importieren!)"
L["Debug"] = "Debug"
...
L["Received Priorities"] = "Prioritäten empfangen"
L["Accept incoming"] = "Eingehende akzeptieren"
L["Reject and keep mine"] = "Ablehnen und meine behalten"
