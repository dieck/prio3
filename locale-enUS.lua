...
L["When to output"] = "When to output"
L["What to output"] = "What to output"
L["Language"] = "Language"
...
L["React to loot window"] = "React to loot window"
L["Reacts when you open a loot window."] = "Reacts when you open a loot window."
...
L["On Tooltip"] = "On Tooltip"
L["Shows Prio entries on Item Tooltips"] = "Shows Prio entries on Item Tooltips"
...
L["TotC Dual Loot hc+nhc"] = "TotC Dual Loot hc+nhc"
L["Shows both heroic and normal version of loot on outputs, the respective other one as Playername2"] = "Shows both heroic and normal version of loot on outputs, the respective other one as Playername2. Setting needs to be done before importing, not possible afterwards. (Tip: import again!)"
L["Debug"] = "Debug"
